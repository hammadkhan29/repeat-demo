...
export const StartForm = () => {
  ...
  return (
    <Modal open={open} onClose={handleClose} className='flex justify-center items-center'>
      ...
      <h2 className='font-bold text-2xl m-2 ml-4'>Getting Started</h2>
    <form onSubmit={handleSubmit(onSubmit)}>
    <div className='flex flex-col mx-3'>
        <label className='font-semibold text-lg'>Full Name<span className='text-red-600'>*</span></label>
        <input
        className='h-[30px] rounded-2xl p-1'
          type="text"
          {...register( 'fullName', { required: true })}
        />
        {errors.fullName && <span className=' text-red-600 text-xs'>Name is required</span>}
      </div>
      <div className='flex flex-col mx-3'>
        <label className='font-semibold text-lg'>Email<span className='text-red-600'>*</span></label>
        <input className='h-[30px] rounded-2xl p-1'
          type="email"
      ...
      <div className='flex flex-col mx-3'>
        <label className='font-semibold text-lg'>Job Title<span className='text-red-600'>*</span></label>
        <input
        className='h-[30px] rounded-2xl p-1'
          type="text"
          {...register( 'jobTitle', { required: true })}
        />
        {errors.jobTitle && <span className=' text-red-600 text-xs'>Field is required</span>}
      </div>
      <div className='flex flex-col mx-3'>
      ...
      <div className='flex flex-col mx-3'>
        ...
        <select className='h-[40px] rounded-2xl p-1'  {...register( 'orderVolume' ,{ required: true })}>
      ...
      <div className=' bg-[#F5FF7D] text-white h-[30px] rounded-xl mx-4 w-40 mt-[20px] mb-[20px] text-2x1 text-center'> 
      <button type="submit">Installl the App</button>
      </div>
    </form>
    </div>
    </Modal>
