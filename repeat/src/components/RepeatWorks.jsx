  ...
  return (
    <div className='w-full lg:p-10 bg-[#EDE7DE] pt-[30px]'>
        ...
        <div className='flex justify-between flex-col sm:flex-row'>
            ...
            <h2 className='font-semibold text-left text-[20px] mb-3 ml-3 md:mb-6 leading-[1.5]'>INGEST AND ANALYZE</h2>
            <p className='m-3 leading-[1.5]  text-sm  md:text-left'>
        ...
        <div className='flex justify-between flex-col sm:flex-row'>
            <div className='w-[95%] sm:[50%] m-2'>
            <h2 className='font-semibold text-left text-[20px] mb-3 ml-3  md:mb-6 leading-[1.5]'>TRANSFORM AND REPEAT</h2>
            <p className='m-3 leading-[1.5]  text-sm  md:text-left'>
        ...
        <div className='flex justify-between flex-col sm:flex-row'>
            ...
            <h2 className='font-semibold text-left text-[20px] mb-3 ml-3 md:mb-6 leading-[1.5]'>AUTOMATE AND ACT</h2>
            <p className='m-3 leading-[1.5]  text-sm  md:text-left'>
